...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4">
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="w-full lg:w-1/5 bg-white rounded shadow">
                ...
                <div class="p-2 border-b">
                    <h3 class="font-semibold mb-2">SVG Editor</h3>
                    <div class="grid grid-cols-3 gap-2">
                        <button class="tool-btn p-2 rounded border text-xs">FREE</button>
                        <button class="tool-btn p-2 rounded border text-xs">FREE</button>
                        <button class="tool-btn p-2 rounded border text-xs">FREE</button>
                        <button class="tool-btn p-2 rounded border text-xs">FREE</button>
                        <button class="tool-btn p-2 rounded border text-xs">FREE</button>
            ...
            <div class="w-full lg:w-3/5">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <div class="design-area-container">
                        <canvas id="design-area" width="800" height="500"></canvas>
                ...
                <div class="mt-4 bg-white rounded shadow p-4">
                    ...
                    <div class="flex items-center space-x-4 mt-3">
                        <select id="font-family" class="border rounded p-1">
                        ...
                        <div class="flex space-x-1">
                            <button class="tool-btn p-1 rounded border" id="text-bold" title="Bold">
                                <i class="fas fa-bold"></i>
                            </button>
                            <button class="tool-btn p-1 rounded border" id="text-italic" title="Italic">
                                <i class="fas fa-italic"></i>
                            </button>
                            <button class="tool-btn p-1 rounded border" id="text-underline" title="Underline">
                                <i class="fas fa-underline"></i>
                            </button>
                            <button class="tool-btn p-1 rounded border" id="text-align-left" title="Align Left">
                                <i class="fas fa-align-left"></i>
                            </button>
                            <button class="tool-btn p-1 rounded border" id="text-align-center" title="Align Center">
                                <i class="fas fa-align-center"></i>
                            </button>
                            <button class="tool-btn p-1 rounded border" id="text-align-right" title="Align Right">
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadTshirtView(view) {
                // In a real app, you would have different images for each view
                var imageUrl = '/images/tshirt-' + view + '.png';
            ...
            function getCurrentTextAlign() {
                if ($('#text-align-left').hasClass('active')) return 'left';
                if ($('#text-align-center').hasClass('active')) return 'center';
                if ($('#text-align-right').hasClass('active')) return 'right';
                return 'left';
            }
            ...
            $('#text-align-left').click(function() {
                $('[id^="text-align-"]').removeClass('active');
            ...
            $('#font-family, #font-size, #text-color').change(function() {
                var activeObject = canvas.getActiveObject();
                if (activeObject && activeObject.type === 'text') {
                    if ($(this).attr('id') === 'font-family') {
                        activeObject.set('fontFamily', $(this).val());
                    } else if ($(this).attr('id') === 'font-size') {
            ...
            $('.color-option').click(function() {
                ...
                if (tshirtBase) {
                    // In a real app, you would change the t-shirt color
                    // This is a simplified version that just shows a message
                    alert('T-shirt color changed to: ' + color);
                    // You would implement the actual color change logic here
                    // This might involve replacing the tshirt image with one of the new color
                }
            });
